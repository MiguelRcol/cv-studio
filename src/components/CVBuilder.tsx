  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        ...
        if (visibleSection) {
          setActiveSection(visibleSection.target.id as SectionKey);
        }
      },
      {
    ...
    (["profile", "education", "experience"] as SectionKey[]).forEach(
      (section) => {
      ...
      <div className="cv-workspace" id="top">
        ...
        <section className="cv-editor" aria-label="CV editor">
          <div className="cv-editor-intro">
            <span className="cv-eyebrow">CV Application</span>
          ...
          <p className="cv-editor-footer">
            Built by <a href="https://github.com/MiguelRcol">Miguel Rua</a>. Your CV
            data stays in this tab and resets when the page is refreshed.
          </p>
        </section>
